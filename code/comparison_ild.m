function [] = comparison_ild(liste_angles_given_l,liste_angles_given_r,liste_angles_given,kmax,audio,f,offset)
...
for k=1:kmax
    ...
    liste_angles_estimated(k) = ild(left,right,f);
end
...
title('Comparison between azimuth given and azimuth estimated by ILD');
